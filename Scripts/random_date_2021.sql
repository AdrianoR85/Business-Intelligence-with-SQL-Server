...
BEGIN
	...
	SET @INVOICE_DATE = (SELECT CONVERT(DATE, CONVERT(VARCHAR(15), '2021-' + 
...
/* MONTH */
SELECT CONVERT(VARCHAR(5), (CONVERT(INT, RAND() * 13) + '-')) AS NONTH

/* DAY */
SELECT CONVERT(VARCHAR(5), (CONVERT(INT, RAND() * 27)) + 1) AS DAY

/* DATE */
SELECT CONVERT(DATE, CONVERT(VARCHAR(15), '2021-' + 
	   CONVERT(VARCHAR(5), (CONVERT(INT, RAND() * 12)) + 1) + '-' +
       CONVERT(VARCHAR(5), (CONVERT(INT, RAND() * 27)) + 1))) AS DATE
GO 5
